  ...
  head: () => ({
    meta: [
      { title: "Checkout — MediCare Pharmacy" },
      {
        name: "description",
        content:
          "Confirm delivery details and upload your prescription to complete your order.",
      },
    ...
    return (
      <div className="mx-auto max-w-2xl px-4 py-16 text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Add some medicines to your basket first.
        </p>
      ...
      <Formik
        ...
        onSubmit={async (values, { setSubmitting }) => {
          if (needsPrescription && !file) {
            toast.error(
              "Please attach your prescription for the Rx items in your basket.",
            );
            setSubmitting(false);
            return;
          }
          ...
          try {
            // Create the order in FastAPI / Neon first.
            ...
            if (file) {
              // Ask our Vercel server route for a temporary
              // private Blob upload URL.
              ...
              if (!uploadUrlResponse.ok) {
                throw new Error(
                  "Could not prepare prescription upload",
                );
              }
              ...
              // Upload the prescription directly from the
              // browser to private Vercel Blob storage.
            ...
            toast.success(
              "Order placed! Our pharmacy team will take it from here.",
            );
            ...
            <div className="space-y-5 rounded-2xl border border-border bg-card p-6">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="prescription">
                  Prescription{" "}
                  {needsPrescription ? "(required)" : "(optional)"}
                </Label>
                ...
                <p className="text-xs text-muted-foreground">
                  JPG, PNG or PDF. Stored privately and reviewed by a
                  pharmacist.
                </p>
              </div>
              ...
              {needsPrescription && (
                <p className="flex items-start gap-2 rounded-xl bg-rx/10 p-3 text-xs text-rx">
                  ...
                  Your basket contains prescription-only medicines. They
                  will be dispensed only after verification.
                </p>
              )}
            </div>
