...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      {
        title:
          "MediCare Pharmacy — Prescription & OTC Medicines Online",
      },
      {
        name: "description",
        content:
...
const perks = [
  {
    ...
    text: "Every Rx order is checked before dispensing.",
  },
  {
    icon: FileCheck2,
    title: "Easy prescriptions",
    text: "Upload a photo or PDF at checkout.",
  },
  {
    icon: Truck,
    title: "Next-day delivery",
    text: "Discreet, tracked packaging nationwide.",
  },
  {
    icon: Clock,
    title: "Refill reminders",
    text: "Reorder past medicines in one tap.",
  },
];
    ...
    return (
      <div className="mx-auto max-w-2xl px-4 py-20 text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Start the backend service and refresh this page
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-16 lg:grid-cols-2 lg:py-24">
          <div className="text-primary-foreground">
            ...
            <p className="mt-4 max-w-lg text-base text-primary-foreground/85">
              Browse over-the-counter essentials or
              upload a prescription — our pharmacists
              verify every order before it ships to your
              door.
            </p>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-6">
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Everyday essentials our customers reorder
              most.
            </p>
          </div>
